...
python EISFittingModelDefinitions.py --mode=train --logdir=OnePercentTraining_june30 --num_zarcs_training_lower=1 --inductances_training_lower=0 --inception_training_lower=0 --num_conv=5 --conv_filters=40
