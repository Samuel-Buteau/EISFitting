...
python EISFittingModelDefinitions_v2.py --mode=train --logdir=OnePercentTraining_big4 --num_zarcs_training_lower=1 --inductances_training_lower=0 --num_conv=5 --conv_filters=56
